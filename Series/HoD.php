...
<div class="content"style="padding-top:100px";>
  <h2 class="title">House of the Dragons</h2>
...
<iframe id="video-player" src="https://uqload.co/embed-ie4nwbnfoe5k.html" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="640" height="360" allowfullscreen></iframe>

</div>

<select id="episode-selector">
  <optgroup label="Saison 1"style="font-size:30px;">
    <option value="https://uqload.co/embed-ie4nwbnfoe5k.html">S1 Episode 1</option>
    <option value="https://uqload.co/embed-586vc5b6x961.html">S1 Episode 2</option>
    <option value="https://uqload.co/embed-2oqypriudow7.html">S1 Episode 3</option>
    <option value="https://uqload.co/embed-kq8t81sxpc0b.html">S1 Episode 4</option>
    <option value="https://uqload.co/embed-2a5gcetoa1eh.html">S1 Episode 5</option>
    <option value="https://uqload.co/embed-iawdvstgz2jd.html">S1 Episode 6</option>
    <option value="https://uqload.co/embed-m2etywp1ldlz.html">S1 Episode 7</option>
    <option value="https://uqload.co/embed-c03i0gi1biy7.html">S1 Episode 8</option>
    <option value="https://uqload.co/embed-pl38tl2libda.html">S1 Episode 9</option>
    <option value="https://uqload.co/embed-wfac3rjyn4hf.html">S1 Episode10</option>
  </optgroup>
...
$id_film = 3; // Remplacez 1 par l'identifiant du film/série
