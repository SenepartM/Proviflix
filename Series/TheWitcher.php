...
<iframe id="video-player" src="https://uqload.co/embed-tppuu5a3t2uo.html" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="640" height="360" allowfullscreen></iframe>

</div>

<select id="episode-selector">
  <optgroup label="Saison 1"style="font-size:30px;">
    <option value="https://uqload.co/embed-tppuu5a3t2uo.html">S1 Episode 1</option>
    <option value="https://uqload.co/embed-3e9x7adot0ln.html">S1 Episode 2</option>
    <option value="https://uqload.co/embed-svoknl5t11kh.html">S1 Episode 3</option>
    <option value="https://uqload.co/embed-tpbheue1dur3.html">S1 Episode 4</option>
    <option value="https://uqload.co/embed-lcfkoi0q4pdu.html">S1 Episode 5</option>
    <option value="https://uqload.co/embed-fxi56xjsl1jp.html">S1 Episode 6</option>
    <option value="https://uqload.co/embed-schfuift686b.html">S1 Episode 7</option>
    <option value="https://uqload.co/embed-u6x8z3icsqos.html">S1 Episode 8</option>
  </optgroup>
  <optgroup label="Saison 2"style="font-size:30px;">
    <option value="https://uqload.co/embed-ko6pzf57a7gy.html">S2 Episode 1</option>
    <option value="https://uqload.co/embed-xlrnwdqyc5e2.html">S2 Episode 2</option>
    <option value="https://uqload.co/embed-psryrt00hrn2.html">S2 Episode 3</option>
    <option value="https://uqload.co/embed-kk9x6dk7qeg0.html">S2 Episode 4</option>
    <option value="https://uqload.co/embed-0qvtovwj5cea.html">S2 Episode 5</option>
    <option value="https://uqload.co/embed-pti48aj1lrac.html">S2 Episode 6</option>
    <option value="https://uqload.co/embed-kr41yvf753a2.html">S2 Episode 7</option>
    <option value="https://uqload.co/embed-00kt9342mavb.html">S2 Episode 8</option>
...
$id_film = 4; // Remplacez 1 par l'identifiant du film/série
...
if (isset($_POST['ajouter_favori'])) {
    ...
    header("Location: TheWitcher.php");
    exit();
